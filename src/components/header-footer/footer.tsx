...
const Footer = () => {
  ...
  return (
    <footer className="border-t bg-background/50 backdrop-blur-xl mt-50">
      <div className="max-w-5xl mx-auto w-full px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs mb-6">
              Building amazing products that help people achieve their goals.
            </p>
            {/* Social Links */}
        ...
        <div className="pt-6 border-t flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            © {currentYear} Ollio. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
